...
const baseStyle = 'flex flex-grow items-center gap-1 bg-slate-200 rounded p-1 px-2 cursor-pointer'
...
const ChatHeader = ({ selectedTab, setSelectedTab }) => {
    ...
    console.log('selected tab', selectedTab, typeof selectedTab)

    return (
        <>
            <div className={`${baseStyle} ${selectedTab == 1 ? 'bg-green-400' : ''}`} onClick={() => handleClick(1)}>
                <img
            ...
            <div className={`${baseStyle} ${selectedTab == 2 ? 'bg-green-400' : ''}`} onClick={() => handleClick(2)}>
                <img
            ...
            <div className={`${baseStyle} ${selectedTab == 3 ? 'bg-green-400' : ''}`} onClick={() => handleClick(3)}>
                <img
