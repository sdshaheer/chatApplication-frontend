...
const ChatHeader = ({ selectedTab, setSelectedTab }) => {
    ...
    return (
        <>
            <div className={`${baseStyle} ${selectedTab === 1 ? 'bg-green-300' : ''}`} onClick={() => handleClick(1)}>
                <img
            ...
            <div className={`${baseStyle} ${selectedTab === 2 ? 'bg-green-300' : ''}`} onClick={() => handleClick(2)}>
                <img
            ...
            <div className={`${baseStyle} ${selectedTab === 3 ? 'bg-green-300' : ''}`} onClick={() => handleClick(3)}>
                <img
